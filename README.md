...
> **Live demo:** [https://tl-challenge-web-dev.railway.app/](https://tl-challenge-web-dev.railway.app/) — see [Demo Webapp](#demo-webapp) for setup notes, mock documents, and the walkthrough video.

- [Section 1 — Understanding the Problem](#section-1---understanding-the-problem)
...
The demo webapp is hosted [here](https://toughleaf-production.up.railway.app).

Mock compliance documents can be found in the [mock-docs](https://github.com/jchaselubitz/ToughLeaf/tree/main/mock-docs) folder.
...
[Demo video](https://youtu.be/6es_FfoIssE)
